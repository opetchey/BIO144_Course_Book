...
**Think–Pair–Share** What kinds of biological outcomes can you think of that *cannot* be negative or continuous?
...
**Think–Pair–Share** Which assumption of linear regression do you think is most problematic for count data?
...
**Think–Pair–Share** Which of these properties is violated if we use a normal distribution for counts?
...
**Think–Pair–Share** What features of this plot might already make you suspicious about using linear regression?
...
**Think–Pair–Share** What would go wrong if we used an identity link for count data?
...
**Think–Pair–Share** If $\beta=0.05$ what change in the expected count would be caused by an increase in body mass of 1 kg? As well as a numeric value, specify whether it is used additively or multiplicatively.
...
**Think–Pair–Share** Why might individuals differ even after accounting for measured predictors?
...
**Think–Pair–Share** Can you think of an ecological, biological, or medical process that would generate many structural zeros?
...
**Think–Pair–Share** How would you visualise (make a graph) of the data and the modelled relationships? Make a sketch of what you could do.
