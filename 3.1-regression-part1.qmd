...
**Think, Pair, Share** (#guess-params) Make a guess of the slope. Make a guess of the intercept (hint be careful, lots of people get this wrong).
...
**Think, Pair, Share** (#odd-data) Where on this graph would you expect to see particularly influential outliers? Influential in the sense that they would have a large effect on the slope of the line of best fit.
...
**Think, Pair, Share** (#like-weight) What quantity that we already experienced is like the weight of the child?
