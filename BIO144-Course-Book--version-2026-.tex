...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, toprule=.15mm, colframe=quarto-callout-important-color-frame, opacitybacktitle=0.6, leftrule=.75mm, rightrule=.15mm, toptitle=1mm, opacityback=0, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, titlerule=0mm, coltitle=black, colbacktitle=quarto-callout-important-color!10!white, left=2mm, arc=.35mm, colback=white, breakable, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, toprule=.15mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, leftrule=.75mm, rightrule=.15mm, toptitle=1mm, opacityback=0, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, titlerule=0mm, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, left=2mm, arc=.35mm, colback=white, breakable, bottomrule=.15mm]
...
\textbf{Think--Pair--Share} (\#tps\_a\_objects\_not\_files) When you
type \texttt{a\ \textless{}-\ ...}, where does \texttt{x} live?
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, toprule=.15mm, colframe=quarto-callout-tip-color-frame, opacitybacktitle=0.6, leftrule=.75mm, rightrule=.15mm, toptitle=1mm, opacityback=0, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, titlerule=0mm, coltitle=black, colbacktitle=quarto-callout-tip-color!10!white, left=2mm, arc=.35mm, colback=white, breakable, bottomrule=.15mm]
...
\begin{center}
\includegraphics[width=14cm,height=\textheight,keepaspectratio]{3.1-regression-part1_files/figure-pdf/unnamed-chunk-51-1.pdf}
\end{center}
...
\pandocbounded{\includegraphics[keepaspectratio]{3.1-regression-part1_files/figure-pdf/unnamed-chunk-53-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{3.1-regression-part1_files/figure-pdf/unnamed-chunk-60-1.pdf}}
...
Residuals:
    Min      1Q  Median      3Q     Max 
-23.420  -6.344   0.530   6.350  24.749 

Coefficients:
              Estimate Std. Error t value Pr(>|t|)    
(Intercept)   92.55145    3.33820  27.725  < 2e-16 ***
age            0.46473    0.05229   8.887 3.38e-14 ***
mins_exercise -0.09810    0.01094  -8.972 2.23e-14 ***
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1

Residual standard error: 9.011 on 97 degrees of freedom
Multiple R-squared:  0.7012,    Adjusted R-squared:  0.6951 
F-statistic: 113.8 on 2 and 97 DF,  p-value: < 2.2e-16
\end{verbatim}

In the final line of output we see ``F-statistic: 113.82 on 2 and 97 DF,
p-value: \ensuremath{3.59\times 10^{-26}}''.
...
associated with blood pressure (F(2, 97) = 113.82, p =
\ensuremath{3.59\times 10^{-26}}).'' Note that this is rather an
...
\begin{verbatim}
                 Estimate Std. Error   t value     Pr(>|t|)
(Intercept)   92.55144905 3.33819506 27.724997 6.751420e-48
age            0.46472655 0.05229007  8.887473 3.378809e-14
mins_exercise -0.09810378 0.01093501 -8.971528 2.226953e-14
\end{verbatim}
...
\begin{verbatim}
                   2.5 %     97.5 %
(Intercept)   85.9260559 99.1768422
age            0.3609452  0.5685079
mins_exercise -0.1198068 -0.0764008
\end{verbatim}
...
strong correlation among explanatory variables make estimates unstable
...
interpretation of a coefficient change when you add another explanatory
...
\bottomrule\noalign{}
\endlastfoot
(Intercept) & 92.551 & 3.338 & 27.725 & 0 & 85.926 & 99.177 \\
age & 0.465 & 0.052 & 8.887 & 0 & 0.361 & 0.569 \\
mins\_exercise & -0.098 & 0.011 & -8.972 & 0 & -0.120 & -0.076 \\
\end{longtable}
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, toprule=.15mm, colframe=quarto-callout-caution-color-frame, opacitybacktitle=0.6, leftrule=.75mm, rightrule=.15mm, toptitle=1mm, opacityback=0, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, titlerule=0mm, coltitle=black, colbacktitle=quarto-callout-caution-color!10!white, left=2mm, arc=.35mm, colback=white, breakable, bottomrule=.15mm]
...
for continuous response variables. However, many biological response
variables are counts (e.g., number of offspring, number of parasites).
In this chapter, we introduce \textbf{Generalized Linear Models (GLMs)}
for analysing count data, focusing on the Poisson distribution.
...
biological outcomes (response variables) can you think of that
\emph{cannot} be negative or continuous?
...
hypothetical observations, not the single observed value \(y_i\).
...
regardless of the values of the explanatory variables. Whatever the
value of the linear predictor \(\eta_i\), the exponential of it
\(\exp(\eta_i)\) is always positive.
...
differ even after accounting for measured explanatory variables?
...
generalized linear models (GLMs) to handle \textbf{count responses} with
a Poisson GLM. In this chapter we move to another common case:
...
\(\pi_i = P(y_i = 1)\) \textbf{of the response variable?}
...
\textbf{Think--Pair--Share} (\#tps-binary-examples) Name three response
variables in biology, ecology, or medicine that are naturally binary
(0/1). Why would a linear model be risky for each?
...
Binary responses often first appear in a \textbf{contingency table}. For
example:
...
\tightlist
\item
  they typically compare \textbf{groups} (few categorical explanatory
  variable),
\item
  they don't easily handle \textbf{continuous explanatory variables}
  (e.g.~dose),
\item
...
trials''. Use a binomial model when each observation is a 0/1 response.
...
response variable? And which link function is this, by the way?
