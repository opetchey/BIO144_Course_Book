...
[**Think–Pair–Share** (#a_interpreting_slope) In words, what does the slope represent in this model? What does it *not* tell you?]{.mark}
...
[**Think–Pair–Share** (#a_linear_model_assumptions) Which assumption of linear regression feels most fragile in real biological data? Why?]{.mark}
