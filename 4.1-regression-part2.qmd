...
ggplot(data.frame(x = seq(-4, 4, 0.01)), aes(x = x)) +
  ...
  labs(title = "t-distribution with 1000 degrees of freedom (blue) and normal distribution (orange)",
       x = "t-value", y = "density")
```
