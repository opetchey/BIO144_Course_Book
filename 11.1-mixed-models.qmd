...
::: {.callout-important}
**Core idea** A *mixed model* extends over all our previous models by adding **random effects** that represent grouping structure (clusters) in the data.
...
#| echo: false Let's make an example dataset to illustrate:
